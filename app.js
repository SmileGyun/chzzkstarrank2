...
document.addEventListener('DOMContentLoaded', async () => {
    // --- [사용자 백업 데이터] ---
    const backupPlayers = [
        { id: "1", name: "제리123", race: "Zerg", rating: 2560, win: 8, loss: 0, prevRank: 1 },
        { id: "2", name: "아미1", race: "Protoss", rating: 2335, win: 7, loss: 5, prevRank: 2 },
        { id: "3", name: "채선트", race: "Protoss", rating: 2285, win: 7, loss: 7, prevRank: 3 },
        { id: "4", name: "코을", race: "Terran", rating: 2267, win: 8, loss: 6, prevRank: 4 },
        { id: "5", name: "냔땐구", race: "Terran", rating: 2248, win: 0, loss: 0, prevRank: 5 },
        { id: "7", name: "나브자크", race: "Random", rating: 2172, win: 4, loss: 0, prevRank: 6 },
        { id: "6", name: "에뚜랑제", race: "Zerg", rating: 2162, win: 7, loss: 5, prevRank: 7 },
        ...
        { id: "11", name: "하늘루틴", race: "Zerg", rating: 2020, win: 1, loss: 0, prevRank: 11 },
        { id: "12", name: "전설의마왕9658", race: "Terran", rating: 2015, win: 4, loss: 2, prevRank: 12 },
